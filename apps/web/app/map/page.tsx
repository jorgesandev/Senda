...
import { RouteStepBar } from '@/components/RouteStepBar'
  ...
  return (
    <main className="h-[100dvh] overflow-hidden bg-map text-text">
      ...
      <section className="relative h-full">
        ...
        {/* Barra superior + controles flotantes apilados */}
        <div className="absolute inset-x-3 top-[calc(env(safe-area-inset-top)+0.75rem)] z-40 mx-auto flex max-w-[560px] flex-col gap-2 md:left-4 md:right-auto md:mx-0 md:w-[520px]">
          {hasStartedRoute && activeRoute ? <RouteStepBar /> : <RoutePlanner />}
